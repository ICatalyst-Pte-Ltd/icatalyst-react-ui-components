...
import { SnackbarProps } from '../../notifications';
export type MessageStore = SnackbarProps;
export declare const message: import("@reduxjs/toolkit").Slice<SnackbarProps, {
    showMessage: (_: import("immer/dist/internal").WritableDraft<SnackbarProps>, action: PayloadAction<Omit<SnackbarProps, 'open'>>) => {
        open: true;
        ...
        variant?: "message" | "error" | "warning" | "info" | "success" | undefined;

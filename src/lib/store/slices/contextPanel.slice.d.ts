...
import { ContextPanelProps } from '../../panels';
export type ContextPanelStore = Omit<ContextPanelProps, 'children'> & {
    children?: ReactElement;
};
export declare const dialog: import("@reduxjs/toolkit").Slice<ContextPanelStore, {
    openPanel: (_: import("immer/dist/internal").WritableDraft<ContextPanelStore>, action: PayloadAction<Omit<ContextPanelProps, 'open'>>) => {
        open: true;
        ...
        position?: import("../../panels").ContextPanelPosition | undefined;

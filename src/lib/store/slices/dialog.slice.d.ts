...
export type DialogStore = DialogProps;
export declare const dialog: import("@reduxjs/toolkit").Slice<DialogProps, {
    openDialog: (_: import("immer/dist/internal").WritableDraft<DialogProps>, action: PayloadAction<Omit<DialogProps, 'open'>>) => {
        open: true;
